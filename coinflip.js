...
async function handler(msg, args) {
  ...
  await safeReply(msg, 'Coin flip: ' + out);
}

if (!autoRegister('.coinflip', 'Flip a coin', handler)) {
  module.exports = (client) => registerWithClient(client, '.coinflip', 'Flip a coin', handler);
}
