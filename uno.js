...
async function handler(msg, args) {
  return safeReply(msg,'UNO simplified is not implemented in this package. Use .games to see available single-player games.');
}

if (!autoRegister('.uno', 'UNO (multiplayer)', handler)) {
  module.exports = (client) => registerWithClient(client, '.uno', 'UNO (multiplayer)', handler);
}
